...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["740415701075886127"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`HelmsDeep ❤️ Yiğitcan`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ["stat", "kayıtlar", "kayıt-kontrol","info"],
    permLvl: 0,
}
